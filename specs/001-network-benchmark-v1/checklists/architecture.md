...
| No trata una propuesta como aprobación | Cumple | Q2 y conflictos siguen como gates |
...
| ADR-002 aceptado antes del bootstrap | Pendiente | propietario; arquitectura aún propuesta |
...
| Runtime/seguridad/persistencia usan ADR | Pendiente | aceptar ADR-001–ADR-006 antes del bootstrap afectado |
...
| Umbral Q2 ratificado | Pendiente | propietario antes del gate numérico L00 |
...
| Manifiesto latest estable frente a URL versionada | Cumple | FR-042 alineado el 2026-09-21: `latest.json` estable con artefacto en URL por etiqueta; T125 lo registra en ADR |
| Feature-first frente a `Historias.md` §25 | Pendiente | aceptar ADR-002 antes de L00 |
