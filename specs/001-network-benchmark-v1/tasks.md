...
- [ ] T143 CRITICAL Implementar el servidor del canal de control que escucha en `CONTROL_PORT_DEFAULT`, acepta HELLO/PAIR/REQUEST y aplica el límite de una sesión activa, arrancándolo desde `src-tauri/src/app.rs`, según FR-009 y US1/AC1 (missing) — **parcial el 2026-09-23**: `src-tauri/src/control/server.rs` escucha, completa TLS mutuo, intercambia HELLO, declara ocupación y arranca desde `app::start_control_server`. Faltan PAIR y REQUEST, que dependen de T153
